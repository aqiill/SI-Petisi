...
<html lang="en">
  <head>
    ...
    <title>Kategori <?= ucwords($_GET['q']) ?></title>
  </head>
  <body>
...
<main id="main">
    ...
    <section id="search-result" class="search-result">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-9">
            <h3 class="category-title">Search Results Kategori: <?= ucwords($_GET['q']) ?></h3>
            <?php
               ...
               $petisi = $collection->petisi->find(['kategori' => new \MongoDB\BSON\Regex($_GET['q'])]);
